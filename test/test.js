...
var expressWs2 = require('../index');

describe('express-ws2', function() {
  ...
  beforeEach(function(done) {
    ...
    app = express();
    expressWs2({app: app, router: express.Route, server: server});
  ...
  describe('app.ws()', function() {
    ...
    it('should work with express router', function(done) {
      var callback = sinon.spy();
